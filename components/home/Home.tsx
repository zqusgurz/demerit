...
const Home = () => {
    ...
    return (
        <section id="home" className="container flex flex-col items-center h-screen">
            <div className="font-bold " style={{ fontSize: isMobile ? '4vw' : '2vw', marginTop: isMobile ? '10vw' : '5vw', marginBottom: '3vw', color: isMobile ? "rgba(255,255,255)" : '#000' }}>미팅놈들 벌점 조회</div>
